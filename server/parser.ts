...
import type { Diagnostic, EventKind, TranscriptEvent } from '../shared/types.js';
...
export async function parseFile(filePath: string, sourceId: string): Promise<ParsedFile> {
